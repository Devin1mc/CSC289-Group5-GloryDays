...
def add_item():
    list_base_ids()  # Show existing Base Item IDs before adding a new item
    ...
    # Platform selection including "Other"
    print("\nSelect Platform:")
    print("1: Xbox")
    print("2: PlayStation")
    print("3: PC")
    print("4: Other (e.g., Nintendo Switch, VR, etc.)")
    platform = input("Enter platform number: ")

    if platform not in platform_map:
        print("Invalid platform choice. Please try again.")
        conn.close()
        return
    ...
    if quality not in quality_map or packaging not in ["0", "1"]:
